...
@version 1.0
	...
	...
	@obs O retorno da consulta é pública (__cRetorno) para ser usada em consultas especÃ­ficas
	A consulta não pode ter ORDER BY, pois ele já é especificado em um parÃ¢metro
/*/
